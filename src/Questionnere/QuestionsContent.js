  ...
  essential2: [
    {
      ...
      options: [
        ...
        [
          "Application of patches, updates, or vendor mitigations for vulnerabilities in internet-facing services within 48 hours of assessment as critical by vendors or when working exploits exist.",
          4,
        ],
        [
        ...
        [
          "Application of patches, updates, or vendor mitigations for vulnerabilities in office productivity suites, web browsers, email clients, PDF software, and security products within two weeks of release.",
          7,
        ],
        [
    ...
    },
    {
      ...
      options: [
        ...
        [
          "Application of patches, updates, or other vendor mitigations for vulnerabilities in office productivity suites, web browsers, email clients, PDF software, and security products within 48 hours of assessment as critical by vendors or when working exploits exist.",
          2,
        ],
        [
          "Ensuring office productivity suites, web browsers, email clients, PDF software, and security products do not have vulnerabilities older than two weeks.",
  ...
  essential3: [
    ...
    },
    {
      ...
      options: [
        ...
        [
          "Annual validation of the list of trusted publishers for Microsoft Office macros.",
          12,
        ],        
      ],
      choosedOption: null,
